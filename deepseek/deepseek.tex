...
%======================================================================
\sectionTitle{技术栈}{\faWrench}
%======================================================================
\begin{itemize}
    \item 编程语言：TypeScript, Python, Node.js, JavaScript
    \item 后端框架：Node.js, REST API, MCP 协议（JSON-RPC）, 事件循环调度
    \item AI/ML：LLM API 集成, RLHF 数据构建, 模型评估, 数据分析（Pandas, NumPy）
    \item 工具链：Git, Linux, Docker, Vim/Neovim, CLI 开发
\end{itemize}
