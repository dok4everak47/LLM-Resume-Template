...
%======================================================================
\begin{itemize}
    \item \textbf{后端}: Node.js / TypeScript, Python, REST API, MCP 协议（JSON-RPC）
    \item \textbf{前端基础}: HTML, CSS, JavaScript
    \item \textbf{工具链}: Git, Linux, Docker, Vim/Neovim, VSCode
    \item \textbf{数据/AI}: Pandas, NumPy, scikit-learn, LLM API 集成
\end{itemize}
