...
\begin{itemize}
    ...
    \item \textbf{数据 / ML}: Pandas, NumPy, scikit-learn, LLM API 集成
    \item \textbf{Agent 工程}: Agent Loop, Tool Use, MCP 协议, Memory 系统, Context Engineering
    \item \textbf{工具链}: Git, Linux, Docker, Vim/Neovim, CLI 开发
\end{itemize}
