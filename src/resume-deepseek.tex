...
%======================================================================
\begin{itemize}
    \item \textbf{Claude Code from Scratch} \hfill 20XX.X --- 20XX.X
    \begin{itemize}
        \item \textbf{项目简介}: 从零实现 Claude Code 核心功能的开源学习项目，深入理解 Agent Loop、Tool System 和 Prompt 模板机制
        \item \textbf{技术方案}: Python 实现 Agent 框架，支持自定义工具（count\_lines、git\_status 等）、模板变量（\{\{user\_name\}\}、\{\{project\_name\}\}）和 CLAUDE.md 规则注入
        \item \textbf{技术栈}: Python, dotenv, Jinja2-like 模板引擎, CLI 设计
    \end{itemize}

    \item \textbf{LeetCode TI150 刷题笔记} \hfill 20XX.X --- 至今
    \begin{itemize}
        \item \textbf{项目简介}: LeetCode Top Interview 150 分类刷题记录，涵盖数组、链表、树、动态规划等 23 个分类
        \item \textbf{实现方式}: 本地 Obsidian 笔记 + index.html 可视化进度追踪，每题包含思路分析、多解法对比和复杂度分析
        \item \textbf{技术栈}: Python, JavaScript, HTML, Markdown
    \end{itemize}
\end{itemize}
